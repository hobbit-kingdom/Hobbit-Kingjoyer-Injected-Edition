...
// Win32 window creation, Direct3D9 device management and the Dear ImGui
// render-loop lifecycle. Pure platform plumbing - none of the cheat menu logic
// lives here. Split out of gui.cpp.
